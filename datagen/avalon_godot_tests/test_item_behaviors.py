...
from datagen.avalon_godot_tests.test_animal_behaviors import verify_observations
from datagen.godot_env import DebugCameraAction
from datagen.world_creation.entities.altar import Altar
from datagen.world_creation.entities.constants import FOOD_TREE_BASE_HEIGHT
from datagen.world_creation.entities.food import FOODS as _FOODS
from datagen.world_creation.entities.food import Avocado
from datagen.world_creation.entities.food import Banana
from datagen.world_creation.entities.food import Carrot
from datagen.world_creation.entities.food import Fig
from datagen.world_creation.entities.food import Food
from datagen.world_creation.entities.food import Honeycomb
from datagen.world_creation.entities.food import Mulberry
...
def food_scenario(
    ...
    food_name = (food[1] if is_on_tree else food).__class__.__name__.lower()
