...
from datagen.avalon_godot_tests.scenario import BehaviorManifest
from datagen.avalon_godot_tests.scenario import Scenario
from datagen.avalon_godot_tests.scenario import ScenarioObservations
from datagen.avalon_godot_tests.scenario import get_vr_action
from datagen.avalon_godot_tests.scenario import read_human_recorded_actions
from datagen.godot_env import DebugCameraAction
...
from datagen.world_creation.entities.animals import Alligator
from datagen.world_creation.entities.animals import Animal
from datagen.world_creation.entities.animals import Bear
from datagen.world_creation.entities.animals import Bee
from datagen.world_creation.entities.animals import Crow
from datagen.world_creation.entities.animals import Deer
from datagen.world_creation.entities.animals import Eagle
from datagen.world_creation.entities.animals import Hawk
from datagen.world_creation.entities.animals import Hippo
from datagen.world_creation.entities.animals import Jaguar
from datagen.world_creation.entities.animals import Mouse
from datagen.world_creation.entities.animals import Pigeon
from datagen.world_creation.entities.animals import Rabbit
from datagen.world_creation.entities.animals import Snake
from datagen.world_creation.entities.animals import Squirrel
from datagen.world_creation.entities.animals import Turtle
from datagen.world_creation.entities.animals import Wolf
...
from datagen.world_creation.entities.pillar import Pillar
...
def animal_behavior_manifest_() -> BehaviorManifest:
    manifest_path = Path(__file__).parent / "data/animal_behavior_manifest.json"
    with open(manifest_path) as manifest_file:
        manifest: Dict[str, Any] = json.load(manifest_file)
        return BehaviorManifest(snapshot_commit=manifest["snapshot_commit"], checksums=manifest["checksums"])


@fixture
def inactive_behaviors_() -> List[Scenario]:
    scenarios = []
    all_animals = [*ALL_PREY_CLASSES, *ALL_PREDATOR_CLASSES]
...
def complex_behaviors_() -> List[Scenario]:
    ...
    return [
        Scenario(
            ...
            Bear,
            [Scenario.look_at("bear", 8.0)] + 99 * null_actions,
            items=[obstacle_tree],
            is_animal_facing_player=True,
