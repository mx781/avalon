...
from datagen.world_creation.worlds.height_map import Point2DNP
        ...
        for ideal_shore_dist in ideal_shore_dist_options:
            ...
            for i in range(MAX_SPAWN_TRIES_PER_MAP):
                ...
                if not restricted_found:
                    if is_debugging:
                        print("not far enough from ocean")
                    continue
                ...
                if goal_distance:
                    ...
                    if total_weights <= 0.0:
                        if is_debugging:
                            print("No likely food locations")
                        continue
                ...
                for food_point_2d in food_point_2ds:
                    ...
                    if is_food_visible:
                        ...
                        if final_distance < object_radius * 2.0:
                            ...
                            flatten_radius = min([flatten_radius, final_distance / 2.0])
...
def generate_world_config(
    ...
    is_platonic_world = rand.random() < platonic_world_probability
    ...
    if is_platonic_world:
        ...
        blur_meters_std_dev = 0
        is_smoothed = rand.random() < smoothing_probability
        smooth_min = 0.0
