...
from datagen.world_creation.configs.building import generate_aesthetics_config
...
from datagen.world_creation.constants import WATER_LINE
from datagen.world_creation.constants import AvalonTask
from datagen.world_creation.debug_plots import plot_terrain
from datagen.world_creation.debug_plots import plot_value_grid
from datagen.world_creation.entities.animals import ALL_PREDATOR_CLASSES
from datagen.world_creation.entities.animals import Predator
from datagen.world_creation.entities.constants import CANONICAL_FOOD_HEIGHT_ON_TREE
from datagen.world_creation.entities.constants import FOOD_TREE_VISIBLE_HEIGHT
...
from datagen.world_creation.indoor.building import get_building_footprint_outline
from datagen.world_creation.indoor.constants import DEFAULT_FLOOR_THICKNESS
from datagen.world_creation.indoor.task_generator import MIN_NAVIGATE_BUILDING_SIZE
from datagen.world_creation.indoor.task_generator import create_building_for_skill_scenario
from datagen.world_creation.tasks.bridge import BridgeTaskConfig
from datagen.world_creation.tasks.bridge import create_bridge_obstacle
from datagen.world_creation.tasks.climb import ClimbIndoorTaskConfig
from datagen.world_creation.tasks.climb import ClimbOutdoorTaskConfig
from datagen.world_creation.tasks.climb import ClimbTaskGenerator
from datagen.world_creation.tasks.climb import create_climb_obstacle
from datagen.world_creation.tasks.descend import DescendTaskConfig
...
from datagen.world_creation.tasks.explore import ExploreIndoorTaskConfig
from datagen.world_creation.tasks.explore import ExploreTaskGenerator
from datagen.world_creation.tasks.fight import FightTaskConfig
from datagen.world_creation.tasks.fight import create_fight_obstacle
from datagen.world_creation.tasks.jump import JumpIndoorTaskConfig
from datagen.world_creation.tasks.jump import JumpOutdoorTaskConfig
from datagen.world_creation.tasks.jump import JumpTaskGenerator
from datagen.world_creation.tasks.jump import create_jump_obstacle
from datagen.world_creation.tasks.move import MoveTaskConfig
from datagen.world_creation.tasks.move import create_move_obstacle
from datagen.world_creation.tasks.open import OpenTaskConfig
from datagen.world_creation.tasks.open import OpenTaskGenerator
from datagen.world_creation.tasks.push import PushIndoorTaskConfig
from datagen.world_creation.tasks.push import PushOutdoorTaskConfig
from datagen.world_creation.tasks.push import PushTaskGenerator
from datagen.world_creation.tasks.push import create_push_obstacle
from datagen.world_creation.tasks.stack import StackIndoorTaskConfig
from datagen.world_creation.tasks.stack import StackOutdoorTaskConfig
from datagen.world_creation.tasks.stack import StackTaskGenerator
...
from datagen.world_creation.types import WorldType
from datagen.world_creation.utils import to_2d_point
from datagen.world_creation.worlds.creation import create_world_for_skill_scenario
...
INDOOR_OBSTACLE_CONFIG_DICT: Dict[BuildingTask, Tuple[float, TaskConfig]] = {
...
class CompositeTaskConfig(TaskConfig):
    ...
    indoor_obstacle_configs: Dict[BuildingTask, Tuple[float, TaskConfig]] = INDOOR_OBSTACLE_CONFIG_DICT
...
def create_compositional_task(
    ...
    if is_debug_graph_printing_enabled:
        print("WORLD SIZE:", world.config.size_in_meters ** 2)
        print(
...
def get_building_task_generator_class(building_task: BuildingTask):
    generator_by_task = {
...
def get_random_building_obstacle(
    rand, world: World, task_config: CompositeTaskConfig, locations: WorldLocations, difficulty: float
