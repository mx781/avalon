...
from datagen.world_creation.configs.biome import BiomeConfig
...
from datagen.world_creation.configs.scenery import SceneryConfig
from datagen.world_creation.configs.world import WorldConfig
...
from datagen.world_creation.constants import WORLD_RAISE_AMOUNT
...
from datagen.world_creation.entities.entity import EntityType
from datagen.world_creation.entities.food import CANONICAL_FOOD
from datagen.world_creation.entities.food import CANONICAL_FOOD_CLASS
from datagen.world_creation.entities.food_tree import FoodTree
from datagen.world_creation.entities.scenery import Scenery
from datagen.world_creation.entities.spawn_point import SpawnPoint
...
from datagen.world_creation.noise import perlin
from datagen.world_creation.types import HeightMode
from datagen.world_creation.types import MapBoolNP
from datagen.world_creation.types import MapFloatNP
...
from datagen.world_creation.types import SceneryBorderMode
from datagen.world_creation.utils import normalized
from datagen.world_creation.utils import to_2d_point
from datagen.world_creation.worlds.biome_map import BiomeMap
from datagen.world_creation.worlds.biome_map import make_biome
from datagen.world_creation.worlds.biome_map import plot_biome_grid
from datagen.world_creation.worlds.height_map import FrozenHeightMap
from datagen.world_creation.worlds.height_map import HeightMap
from datagen.world_creation.worlds.height_map import SpecialBiomes
from datagen.world_creation.worlds.height_map import build_outdoor_world_map
from datagen.world_creation.worlds.height_map import selected_distance_weighted_points
from datagen.world_creation.worlds.obstacles.harmonics import create_harmonics
from datagen.world_creation.worlds.obstacles.height_solution import add_detail_near_items
from datagen.world_creation.worlds.obstacles.obstacle import create_obstacle_masks
from datagen.world_creation.worlds.obstacles.ring_obstacle import RingObstacle
from datagen.world_creation.worlds.obstacles.ring_obstacle import RingObstacleConfig
from datagen.world_creation.worlds.terrain import Terrain
from datagen.world_creation.worlds.utils import signed_line_distance
...
class World(Serializable):
    ...
    map: FrozenHeightMap = attr.ib(converter=lambda x: x.freeze())
    items: Tuple[Entity, ...] = attr.ib()
    buildings: Tuple[Building, ...] = attr.ib()
    obstacle_zones: Tuple[Tuple[MapBoolNP, MapBoolNP], ...] = attr.ib()
    ...
    def add_item(self, item: EntityType, reset_height_offset: Optional[float] = None) -> "World":
        if isinstance(item, FoodTree):
            ...
            item = attr.evolve(item, entity_id=num_trees)
    ...
    def make_natural_biomes(
        ...
        new_items = list(self.items) + scenery_items
                ...
                for i in range(len(new_items)):
                    ...
                    if isinstance(item, Scenery):
                        if "trees/" in item.resource_file:
                            fixed_items.append(attr.evolve(item, resource_file="res://scenery/trees/fir.tscn"))
                        else:
                            pass
                    else:
                        fixed_items.append(item)
        ...
        return biome_map, attr.evolve(self, items=tuple(new_items))
