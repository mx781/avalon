...
from datagen.world_creation.entities.food import NON_TREE_FOODS
...
from datagen.world_creation.worlds.compositional import get_random_predator
from datagen.world_creation.worlds.compositional import remove_close_predators
from datagen.world_creation.worlds.difficulty import get_rock_probability
...
def create_tool(position, rand: np.random.Generator, world: World, difficulty: float) -> World:
...
def create_forage_food(position, rand: np.random.Generator, world: World) -> World:
