...
from datagen.world_creation.indoor.builders import get_free_obstacle_sites
...
from datagen.world_creation.indoor.components import Wall
...
from datagen.world_creation.indoor.task_generator import _decide_boulder_mass
...
from datagen.world_creation.indoor.task_generator import decide_spawn_room_and_tile
...
from datagen.world_creation.indoor.tiles import tile_centroid
...
from datagen.world_creation.worlds.utils import add_offsets
...
class PushTaskGenerator(BuildingTaskGenerator):
    ...
    def _get_blocked_entrance_build_params(
        ...
        target_region_x_range = range(site.index - 1)
        if len(target_region_x_range) > 1:
            target_region_x_range = range(1, site.index - 1)
