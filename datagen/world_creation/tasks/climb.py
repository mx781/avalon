...
def create_climb_obstacle(
    ...
    max_climb_distance = min(
        [
            first(world.get_critical_distance(locations, task_config.min_climb_horizontal_dist)),
            task_config.max_climb_horizontal_dist,
        ]
    )
...
class ClimbTaskGenerator(BuildingTaskGenerator):
    ...
    def add_principal_obstacles(
        ...
        obstacle_params: Tuple[Story, Room, Story, Room]
