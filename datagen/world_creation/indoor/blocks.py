...
class LevelBlock(Block):
    ...
    @classmethod
    def make(cls, centroid: Point3DNP, size: Point3DNP, rotation: Rotation = Rotation.identity(), **kwargs):
...
def make_blocks_from_tiles(grid: np.ndarray, solid_tile_value=0) -> List[Block]:
    """
...
def new_make_block_nodes(
    ...
    rotation: Optional[NDArray[Shape["12,0"], Float]] = np.array([1, 0, 0, 0, 1, 0, 0, 0, 1]),
