...
from common.utils import TEMP_DIR
...
from datagen.world_creation.worlds.compositional import get_building_task_generator_class
...
def compare_files(generated_file_path: Path, reference_file_path: Path):
    ...
    if not filecmp.cmp(generated_file_path, reference_file_path):
        with create_temp_file_path(cleanup=False) as generated_file_copy_path, create_temp_file_path(
            ...
            assert False, (
                f"Generated and reference files don't match\n"
