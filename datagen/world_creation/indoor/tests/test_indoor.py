...
from datagen.world_creation.indoor.building import BuildingNavGraph
from datagen.world_creation.indoor.components import StoryNavGraph
...
from datagen.world_creation.indoor.task_generator import rebuild_with_aligned_entrance
from datagen.world_creation.indoor.tests.fixtures import EMPTY_FILE_CHECKSUM
from datagen.world_creation.indoor.tests.fixtures import ChecksumManifest
from datagen.world_creation.indoor.tests.fixtures import building_
from datagen.world_creation.indoor.tests.fixtures import building_catalog_id_
from datagen.world_creation.indoor.tests.fixtures import buildings_manifest_
from datagen.world_creation.indoor.tests.fixtures import incompatible_building_catalog_id_
from datagen.world_creation.indoor.tests.fixtures import indoor_world_catalog_id_
from datagen.world_creation.indoor.tests.fixtures import indoor_worlds_manifest_
from datagen.world_creation.indoor.tests.fixtures import seed_
from datagen.world_creation.indoor.tests.generate_references import get_file_checksum
from datagen.world_creation.indoor.tests.generate_references import get_path_checksum
from datagen.world_creation.indoor.tests.helpers import add_entrance_if_has_none
from datagen.world_creation.indoor.tests.helpers import compare_files
...
from datagen.world_creation.indoor.tests.helpers import make_indoor_world
from datagen.world_creation.indoor.tests.params import BUILDING_CATALOG
...
def test_building_is_reproducible(seed: float, building_catalog_id: str):
    building_id = 0
...
def test_incompatible_building_raises(seed, incompatible_building_catalog_id):
    building_id = 0
...
def test_indoor_world_matches_reference(
    ...
    make_indoor_world(*indoor_world_params, output_path=temp_path)
