...
from datagen.world_creation.entities.doors.door import Door
from datagen.world_creation.entities.doors.hinge_door import HingeDoor
from datagen.world_creation.entities.doors.locks.door_open_button import DoorOpenButton
from datagen.world_creation.entities.doors.locks.rotating_bar import RotatingBar
from datagen.world_creation.entities.doors.locks.sliding_bar import SlidingBar
from datagen.world_creation.entities.doors.sliding_door import SlidingDoor
from datagen.world_creation.entities.doors.types import HingeSide
from datagen.world_creation.entities.doors.types import LatchingMechanics
from datagen.world_creation.entities.doors.types import MountSlot
...
from datagen.world_creation.indoor.constants import TILE_SIZE
from datagen.world_creation.indoor.constants import Azimuth
from datagen.world_creation.types import Basis3DNP
...
def _get_entrance_door_rotation(entrance: Entrance) -> Basis3DNP:
    if entrance.azimuth == Azimuth.NORTH:
        ...
        raise SwitchError(entrance.azimuth)
    return Rotation.from_euler("y", rotation_degrees, degrees=True).as_matrix().flatten()
