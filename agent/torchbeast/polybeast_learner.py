...
# Loss settings.
parser.add_argument("--entropy_cost", default=2e-3, type=float,
...
parser.add_argument("--grad_norm_clipping", default=100.0, type=float,
...
def test(flags):
    ...
    # Upload any straggling godot errors
    wandb.save(f"{GODOT_ERROR_LOG_PATH}/*", base_path=GODOT_ERROR_LOG_PATH, policy="now")
