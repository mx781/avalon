...
class FixedWandbLogger(WandbLogger):
    ...
    def experiment(self) -> Run:
        ...
        if self._experiment is None:
            ...
            self._experiment: Run = self.init_wandb()  # if wandb.run is None else wandb.run
...
GODOT_DIR_HASH = hash_dirpath(ROOT_DIR + "/datagen/godot/**/*")
